<!-- Loket 1 Antrian DPMPTSP Provinsi Riau 
**********************************************
...
<body class="d-flex flex-column h-100">
  <main class="flex-shrink-0">
    <div class="container pt-4 text-white">
      <div class="d-flex flex-column flex-md-row px-4 py-3 mb-4 bg-white rounded-2" style="background-image: url(9.png); background-size: cover;
      ...
      <div class="row" >
        ...
        <div class="col-md-3 mb-4">
          <div class="card border-0" style="background-image: url(9.png); background-size: cover;
      box-shadow: rgba(14, 30, 37, 0.12) 0px 2px 4px 0px, rgba(14, 30, 37, 0.32) 0px 2px 16px 0px;">
  ...
  <footer class="footer mt-auto py-4">
    <div class="container">
      <hr class="my-4">
      <div class="copyright text-center mb-2 mb-md-0 text-white">
  ...
  <script type="text/javascript">
    $(document).ready(function() {
      ...
      $('#tabel-antrian tbody').on('click', 'button', function() {
        ...
        setTimeout(function() {
          responsiveVoice.speak("Nomor Antrian, " + data["no_antrian_layanan"] + ", menuju, loket, 4", "Indonesian Male", {
            rate: 0.9,
            pitch: 1,
            volume: 1
          });
