...
<link rel="shortcut icon" href="<?php echo base_url('assets/user')?>/img/dpmptsp_icon.png">
  ...
  <link href="<?php echo base_url('assets/user')?>/lib/themes/metroui.css" rel="stylesheet">
	  ...
	  <ul class="list-group list-group-flush">
	    <li class="list-group-item text-center"><h3>SELAMAT DATANG</h3><h5>DI DINAS PENANAMAN MODAL DAN PELAYANAN TERPADU SATU PINTU Provinsi Riau</h5>
	    	<h8>Jalan Jend. Sudirman No.464, Jadirejo, Kec. Sukajadi, Pekanbaru, Riau 28121</h8>
		</li>
	    <li class="list-group-item text-center">
	    	<div class="row card-link"><?php echo $row->tgl_antrian_layanan ?></div>
	    	<h4>KODE ANTRIAN <?php echo $row->id ?>
		</h4><h4>Nomor Antrian Anda</h4>
		<h1><?php echo $row->no_antrian_layanan ?></h1><h6><?php echo $row->nama_layanan ?> (<?php echo $row->kode_layanan ?>)</h6>
	    </li>
